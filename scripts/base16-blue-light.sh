...
# Blue Stripe theme by Zeal Jagannatha (@zfjagann)
...
color01="fb/bb/c9" # Base 08 - Red
color02="1d/b6/3a" # Base 0B - Green
color03="f8/d6/15" # Base 0A - Yellow
color04="00/54/d0" # Base 0D - Blue
color05="ac/97/d8" # Base 0E - Magenta
color06="5e/b1/e7" # Base 0C - Cyan
